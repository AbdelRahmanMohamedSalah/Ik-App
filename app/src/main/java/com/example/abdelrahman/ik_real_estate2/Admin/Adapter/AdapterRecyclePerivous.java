...
import com.example.abdelrahman.ik_real_estate2.Admin.Activity.RecyclePeriviousAdminActivity;
...
public class AdapterRecyclePerivous extends RecyclerView.Adapter<AdapterRecyclePerivous.Holder>
{
    ...
    Perivous localPerivous;

    public AdapterRecyclePerivous(ArrayList<Perivous> paramArrayList, Context paramContext)
    {
        this.array = paramArrayList;
        this.context = paramContext;
    }

    public AdapterRecyclePerivous(ArrayList<Perivous> paramArrayList, Map<String, Users> paramMap, Context paramContext)
    {
        this.array = paramArrayList;
        this.users = paramMap;
        this.context = paramContext;
    ...
    public AdapterRecyclePerivous(ArrayList<Perivous> paramArrayList, Map<String, Users> paramMap, Context paramContext, String paramString)
    {
        this.array = paramArrayList;
        this.users = paramMap;
        this.context = paramContext;
    ...
    {
         localPerivous = (Perivous)this.array.get(paramInt);
...
//        }
      ...
      final Intent  intent = new Intent(this.context, RecyclePeriviousAdminActivity.class);
        ...
        paramHolder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                AdapterRecyclePerivous.this.context.startActivity(intent);
            }
        });
    }
