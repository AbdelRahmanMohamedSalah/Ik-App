...
public class RecyclePeriviousAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.ic_back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                RecyclePeriviousAdminActivity.this.onBackPressed();
            }
        });
        this.btnDelete.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View paramAnonymousView)
            {
                AlertDialog.Builder alert = new AlertDialog.Builder(RecyclePeriviousAdminActivity.this);
                ...
                alert.setPositiveButton("نعم", new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        RecyclePeriviousAdminActivity.this.databaseReference = FirebaseDatabase.getInstance().getReference().child("Perivous_recycle");
                        RecyclePeriviousAdminActivity.this.databaseReference.child(IntentPerivous.getRequestId()).removeValue();
                        RecyclePeriviousAdminActivity.this.onBackPressed();
                    }
                });
