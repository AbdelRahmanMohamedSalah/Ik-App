...
import com.example.abdelrahman.ik_real_estate2.Admin.Activity.PeriviousAdminDetailsActivity;
...
public class AdapterPerivousAdmin extends RecyclerView.Adapter<AdapterPerivousAdmin.Holder> {
    ...
    public AdapterPerivousAdmin(ArrayList<Perivous> paramArrayList, Context paramContext) {
        this.array = paramArrayList;
        this.context = paramContext;
    }

    public AdapterPerivousAdmin(ArrayList<Perivous> paramArrayList, Map<String, Users> paramMap, Context paramContext) {
        this.array = paramArrayList;
        this.users = paramMap;
        this.context = paramContext;
    }

    public AdapterPerivousAdmin(ArrayList<Perivous> paramArrayList, Map<String, Users> paramMap, Context paramContext, String paramString) {
        this.array = paramArrayList;
        this.users = paramMap;
        this.context = paramContext;
    ...
    public void onBindViewHolder(@NonNull Holder paramHolder, int paramInt) {
        ...
        try {
            ...
            RequestName = users.get(localPerivous.getClientMemberId()).getName();
            if (localPerivous.getPeriviewMemberId().equals("other")) {
                this.PeriviewName = "other";
            } else {
                this.PeriviewName = this.RequestName;
            }
        } catch (Exception e) {
        ...
        final Intent intent = new Intent(this.context, PeriviousAdminDetailsActivity.class);
        ...
        paramHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View paramAnonymousView) {
                AdapterPerivousAdmin.this.context.startActivity(intent);
                ((Activity) AdapterPerivousAdmin.this.context).finish();
            }
        });
    }
